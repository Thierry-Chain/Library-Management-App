...
<div className="card col-11 col-sm-5 mx-auto mt-2">
     <div className="card-header bg-transparent text-secondary border-success">Manage students</div>
...
<div className="card col-11 col-sm-5 mx-auto mt-2">
     <div className="card-header bg-transparent text-secondary border-success">Manage books</div>
  <div className="card-body">
...
<div className="card col-11 col-sm-5 mx-auto mt-2">
     <div className="card-header bg-transparent text-secondary border-success">Lend books</div>
  <div className="card-body">
...
<div className="card col-11 col-sm-5 mx-auto mt-2">
     <div className="card-header bg-transparent text-secondary border-success">Return Books</div>
  <div className="card-body">
...
<div className="card col-11 col-sm-5 mx-auto mt-2">
     <div className="card-header bg-transparent text-secondary border-success">Print Borrowers list</div>
  <div className="card-body">
...
<div className="card col-11 col-sm-5 mx-auto mt-2">
     <div className="card-header bg-transparent text-secondary border-success">Manage teachers</div>
  <div className="card-body">
...
<div className="card col-11 col-sm-5 mx-auto mt-2 mb-3">
     <div className="card-header bg-transparent text-secondary border-success">In addition</div>
  <div className="card-body">
