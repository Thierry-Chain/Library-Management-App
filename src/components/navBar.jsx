...
const NavBar = (props) => {
  ...
  const brand = auth ? (
    <NavbarBrand className="text-brand" to="/">
      <span className="badge d-none d-sm-inline">
        ...
        <NavItem>
          <Dropdown isOpen={dropdownOpen} toggle={toggleDrop}>
            ...
            <DropdownMenu onClick={toggleSmart}>
              ...
              <NavLink to="/loggedIn/studentList">
                <DropdownItem>
                  <i>
                    <BiListUl />
                  </i>{" "}
              ...
              <NavLink to="/loggedIn/studentBorrowers">
                <DropdownItem>
                  <i>
                    <BiListUl />
                  </i>{" "}
              ...
              <NavLink to="/loggedIn/students/records">
                <DropdownItem>
                  <i>
                    <BiListUl />
                  </i>{" "}
        ...
        <NavItem>
          <Dropdown isOpen={dropdownOpenT} toggle={toggleDropT}>
            ...
            <DropdownMenu onClick={toggleSmart}>
              ...
              <NavLink to="/loggedIn/teachersList">
                <DropdownItem>
                  <i>
                    <BiListUl />
                  </i>{" "}
              ...
              <NavLink to="/loggedIn/teachersBorrowers">
                <DropdownItem>
                  <i>
                    <BiListUl />
                  </i>{" "}
              ...
              <NavLink to="/loggedIn/teachers/records">
                <DropdownItem>
                  <i>
                    <BiListUl />
                  </i>{" "}
    ...
    <div className="container-fluid px-0 d-print-none">
      ...
      <Modal isOpen={modal} toggle={toggle}>
        <ModalHeader toggle={toggleModal}>
          <div className="text-center text-info">Are you sure to logout ?</div>
        </ModalHeader>
        <div className="d-flex justify-content-center p-3">
          <button className="btn btn-success mr-4" onClick={logout}>
          ...
          <button className="btn btn-danger ml-4" onClick={toggleModal}>
            <b className="text-light">
              <i>
                <BiXCircle />
              </i>{" "}
      ...
      <Modal isOpen={modalVerify} toggle={() => setModalVerify(!modalVerify)}>
        ...
        <div className="d-flex p-3">
          <button
            ...
            className="btn btn-md btn-success m-auto text-big"
          >
            <i>
              <BiUserCheck />
            </i>{" "}
