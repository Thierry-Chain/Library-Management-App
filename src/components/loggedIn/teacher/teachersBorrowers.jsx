...
import {BiPlusCircle,BiSearch,BiScan} from 'react-icons/bi'
...
this.setState({[name]:value})
 ...
 <thead className="w-100">
   <tr className="w-100">
     <th scope="col" className="w-15 text-nowrap">First-name</th>
     <th scope="col" className="w-15 text-nowrap">Last-name</th>
     <th scope="col" className="text-nowrap">Phone</th>
     <th scope="col" className="">Gender</th>
     <th scope="col" className="w-15 text-nowrap">Book-name</th>
     <th scope="col" className="w-15 text-nowrap">Book-Type</th>
     <th scope="col" className="text-nowrap">Number</th>
...
<input name="word" type="text" value={this.state.word} onChange={this.handleChange} className="form-control bg-light" id="inlineFormInputGroupB" placeholder="Search ..."/>
  <div className="input-group-prepend">
    <div className="input-group-text"><i><BiSearch/></i></div>
       ...
       <button onClick={this.printPage} className="text-monospace mx-auto btn btn-info py-2 p-1 btn-sm text-big"><i><BiScan/></i> Print this page </button>  
       </div>
