      ...
      <section className="mt-5 mt-body bg-pc">
        {this.props.connectionError ? (
          ...
          <React.Fragment>
            ...
            >
              ...
              <form onSubmit={this.handleEdit}>
                <ModalBody>
                  ...
                  <div className="row">
                    ...
                    <Select
                      ...
                      className="form-control col-11 mx-auto col-sm-6 my-2 border-0"
                ...
                <div className="d-flex justify-content-center align-items-center py-2">
                  <button
                    type="submit"
                    className="btn btn-md btn-success w-25 mr-2"
                  >
                    <b>Update</b>
                  </button>
                  <Button
            ...
            >
              ...
              <form onSubmit={this.handleDelete}>
                <div className="text-center">
                  <Alert color="danger">
                    <p className="text-b">
                      This can be danger when you delete teacher who did n't
                      return the book can couse looses
                    </p>
                  </Alert>
                </div>
                <div className="d-flex justify-content-center align-items-center py-2">
            ...
            <Modal
              name="Lend"
              isOpen={this.state.modalLend}
              toggle={this.toggleLend}
            >
              <ModalHeader toggle={this.toggleLend}>
                Lend books to teacher
              </ModalHeader>
              <form onSubmit={this.handleLend}>
                <ModalBody>
                  {errorMessage}
                  {this.state.validationMessage ? (
                    <Alert color="danger">{this.state.validationMessage}</Alert>
                  ) : null}
                  <div className="row">
                    <div className="col-11 mx-auto col-sm-6 my-2">
                      <input
            ...
            >
              <ModalHeader toggle={this.toggleAddNew}>
                Add new teacher
              </ModalHeader>
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    deleteTeacher: (teacherId) =>
      dispatch(teacherActions.deleteTeacher(teacherId)),
    editTeacher: (data, teacherId) =>
