...
class StudentList extends Component {
  ...
  render() {
    ...
    let filteredData
    list.length
      ? (filteredData = list.filter((student) => {
          return (
            student.firstName
              .toLowerCase()
          ...
          {filteredData.map((student) => {
            return (
              <tr key={student._id}>
                ...
                {student.lend === 0 ? (
                  <td className="py-1 disabled text-nowrap">
                    <Link
                      to={`/loggedIn/lend/${student._id}`}
                      className={ClassName}
                    >
                      Lend
                    </Link>
                  ...
                  <td className="py-1 text-nowrap">
                    <Link
                      to={`/loggedIn/lend/${student._id}/${student.lend}`}
            ...
            >
              ...
              <form onSubmit={this.handleDelete}>
                <div className="text-center">
                  <Alert color="danger">
                    <p className="text-b">
                      This can be danger when you delete student who did n't
