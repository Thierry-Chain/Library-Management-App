...
<input name="bookName" value={this.state.bookName}  onChange={this.handleAllChanges} type="text" className="form-control" placeholder="Book Name"/>
</div>

<div className="col-11 mx-auto col-sm-6 my-2">
<input  name="bookId" value={this.state.bookId}  onChange={this.handleAllChanges} type="text" className="form-control" placeholder="Book Id"/>
</div>
...
<div className="col-11 mx-auto col-sm-6 my-2">
<input  name="$bookId" value={this.state.$bookId}  onMouseUp={this.handleAllChanges} onChange={this.handleAllChanges} type="text" className="form-control" placeholder="Book Id"/>
</div>
...
{ errorMessage }
 ...
 <div className="row">
<div className="col-11 mx-auto col-sm-6 my-2">
<input name="$$bookName" value={this.state.$$bookName} required onChange={this.handleAllChanges} type="text" className="form-control" placeholder="Book Name"/>
</div>

<div className="col-11 mx-auto col-sm-6 my-2">
<input  name="$$bookId" value={this.state.$$bookId} required onChange={this.handleAllChanges} type="text" className="form-control" placeholder="Book Id"/>
</div>
...
const mapDispatchToProps=(dispatch)=>{
  return {
lendBook:(data,studentId)=>dispatch(studentActions.lendbook(data,studentId))
  }
}
